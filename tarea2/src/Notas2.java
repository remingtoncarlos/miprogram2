...
public class Notas {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= 3; i++) {
            ...
            System.out.print("Nota participación: "); n1 = entrada.nextFloat();
            System.out.print("1 parcial: ");          n2 = entrada.nextFloat();
            System.out.print("2 parcial: ");          n3 = entrada.nextFloat();
            System.out.print("Examen final: ");       n4 = entrada.nextFloat();
